...
PRODUCTS: list[Product] = [
    # 패션·스타일 (착용 피팅)
    Product(id=0, brand="무무펫", name="코지 니트 스웨터", price=28000, fit=96, category="fashion", species="dog", fittable=True),
    Product(id=1, brand="도그웨어", name="체크 하네스 세트", price=34000, fit=89, category="fashion", species="dog", fittable=True),
    Product(id=2, brand="펫코", name="경량 패딩 베스트", price=42000, fit=94, category="fashion", species="dog", fittable=True),
    Product(id=3, brand="모카독", name="데일리 후디", price=25000, fit=92, category="fashion", species="dog", fittable=True),
    Product(id=4, brand="무무펫", name="윈터 울 코트", price=48000, fit=90, category="fashion", species="dog", fittable=True),
    Product(id=5, brand="캣무드", name="니트 캣 코스튬", price=21000, fit=88, category="fashion", species="cat", fittable=True),
    # 데일리케어
